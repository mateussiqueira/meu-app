      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full">
        <div className="flex justify-between items-center h-full">
          ...
          <div className="hidden md:flex items-center space-x-4 lg:space-x-8">
            ...
            <a href="#" className="text-base font-medium text-gray-700 hover:text-violet-600 transition-colors duration-300 relative after:absolute after:bottom-0 after:left-0 after:h-0.5 after:w-0 hover:after:w-full after:bg-violet-600 after:transition-all after:duration-300">Blog</a>
          </div>
